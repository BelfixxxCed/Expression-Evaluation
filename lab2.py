...
class DFAApp(tk.Tk):
    ...
    Dave's responsibilities implemented here:
    ...
    # ==========================================================================
    # TRANSITION TABLE RENDERING  (Dave)
    # ==========================================================================
    ...
    # ==========================================================================
    # PROCESS HANDLER  (Dave — wires Jeycel's evaluator and writes .out)
    # ==========================================================================
    ...
    def _on_process(self):
        ...
        # Call Jeycel's evaluator via the agreed modular API
